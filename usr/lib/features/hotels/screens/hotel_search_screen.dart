...
class _HotelSearchScreenState extends State<HotelSearchScreen> {
  ...
  Widget _buildHotelCard(BuildContext context, Map<String, dynamic> hotel, String name, String location, double rating, String? imageUrl) {
    return Card(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/room_booking', arguments: hotel);
                      },
